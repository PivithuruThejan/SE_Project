...
@section('content')
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <span class="glyphicon glyphicon-bookmark"></span> This Is Insert Essay Question</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ url('insertessayquestion') }}">
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-4">
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-chevron-circle-up"></i> Insert An Essay Question
                </button>
            </div>
        </div>
